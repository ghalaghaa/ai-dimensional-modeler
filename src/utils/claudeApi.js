...
import { tableRefs as _tableRefs, normTable as _normTable } from './sqlTables';
...
/* SQL FROM/JOIN table + alias extraction lives in sqlTables.js (shared with
   the SSIS lineage parser) — imported above as _tableRefs / _normTable. */
